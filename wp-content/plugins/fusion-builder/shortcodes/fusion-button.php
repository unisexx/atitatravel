		...
		class FusionSC_Button extends Fusion_Element {
			...
			public function render( $args, $content = '' ) {
				...
				if ( $this->args['icon'] ) {
					...
					} elseif ( 'icon_position' === $this->args['hover_transition'] ) {
						$icon_html .= $icon_html;
					}
				}
				...
				if ( 'text_slide_up' === $this->args['hover_transition'] || 'text_slide_down' === $this->args['hover_transition'] ) {
					$button_text = '<div class="awb-button-text-transition">' . $button_text . $button_text . '</div>';
				}
