		...
		<div class="contact-info-container">
			...
			<?php if ( ! empty( $instance['email'] ) ) : ?>
				<?php if ( apply_filters( 'fusion_disable_antispambot', false ) ) : ?>
					<p class="email"><?php esc_html_e( 'Email:', 'Avada' ); ?> <a href="mailto:<?php echo $instance['email']; // phpcs:ignore WordPress.Security.EscapeOutput ?>"><?php echo ( $instance['emailtxt'] ) ? $instance['emailtxt'] : $instance['email']; ?></a></p>
				<?php else : ?>
					<p class="email"><?php esc_html_e( 'Email:', 'Avada' ); ?> <a href="mailto:<?php echo antispambot( $instance['email'] ); // phpcs:ignore WordPress.Security.EscapeOutput ?>"><?php echo ( $instance['emailtxt'] ) ? $instance['emailtxt'] : $instance['email']; ?></a></p>
				<?php endif; ?>
			<?php endif; ?>

			<?php if ( ! empty( $instance['web'] ) && $instance['web'] ) : ?>
				<p class="web"><?php esc_html_e( 'Web:', 'Avada' ); ?> <a href="<?php echo esc_url_raw( $instance['web'] ); ?>">
